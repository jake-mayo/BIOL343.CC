...
|-----------------|-----------------|-----------------|
| population type     | Row 1 value     | Row 1 value     |
| ovary width | Row 2 value     | Row 2 value     |
| ovary height     | Row 3 value     | Row 3 value     |
| flower number     | Row 3 value     | Row 3 value     |
...
library(tidyverse)
library(dplyr)
cc1_data <- read.csv("./data/A1_Data_Excel.csv")   # fill in the path, then delete the leading #
cc1_data_mod<-cc1_data
cc1_data_mod<-cc1_data_mod[1:46,1:8]
names(cc1_data_mod) <- c("population_type","population_name","latitude","longitude","ovary_width","ovary_height","average_august_temperature","flower_number")
ncol(cc1_data_mod)
names(cc1_data_mod)

cc1_data_mod <- cc1_data_mod %>% mutate(average_august_temperature = as.numeric(average_august_temperature))
...
```{r area-histogram}
ggplot(aes(x=ovary_area), data=cc1_data_mod) + 
